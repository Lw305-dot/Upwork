...
# print("Prettified HTML (first 1000 chars):")
...
def scrape_generic(url):
    try:
        ...
        clean = pd.DataFrame({
            ...
            "high price": df[price_col] if price_col else None,
...
#         print(final_df.head())
#         # Save to Excel
#         final_df.to_excel("scraped_markets.xlsx", index=False)
#         print("Data saved to scraped_markets.xlsx")
#     else:
